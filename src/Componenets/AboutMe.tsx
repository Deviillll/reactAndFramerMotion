  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center px-5 font-custombold4   items-center md:w-full h-[40vh] sm:h-[70vh] md:h-[80vh] lg:h-[90vh] xl:h-[100vh] overflow-x-hidden">
        ...
        {/* 2nd div */}
        <div className="lg:text-3xl xl:text-4xl md:text-2xl text-xl -mt-28 sm:-mt-6 md:mt-0 hidden md:block text-zinc-950 whitespace-nowrap overflow-hidden opacity-100 absolute left-[5%]">
