...
const AboutMe = () => {
  ...
  return (
    ...
    >
      {/* 1st div */}
      <div className="flex flex-col  justify-center px-5 font-custombold2 items-center  md:w-full h-[70vh] sm:h-[30vh] md:h-[80vh] lg:h-[90vh] xl:h-[100vh] overflow-x-hidden">
        <div className="lg:text-3xl xl:text-4xl text-xl md:text-2xl md:text-zinc-50 md:opacity-20 absolute left-[5%]">
          <h1> Hi! I'm Hammad,</h1>
        ...
        {/* 2nd div */}
        <div className="lg:text-3xl xl:text-4xl md:text-2xl text-xl -mt-28 sm:-mt-6 md:mt-0 hidden md:block text-white whitespace-nowrap overflow-hidden opacity-100 absolute left-[5%]">
