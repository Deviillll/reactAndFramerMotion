...
const VideoBox = ({ img1, img2, head1, head2 }) => {
  return (
    <div className=" font-custombold9 font-bold overflow-hidden">
      {" "}
      <div className="flex justify-around items-center w-[80vw] group ">
        <img
          ...
          alt=""
        />
        <div className="md:h-[80px] h-6 overflow-hidden text-center ">
          <h1 className="md:text-[5.5vw] text-[4vw] uppercase group-hover:text-fuchsia-400 text-zinc-50 group-hover:-translate-y-full transition-all ease-linear duration-[0.5]">
            {head1}
          </h1>
          <h1 className="md:text-[5.5vw]  uppercase group-hover:text-fuchsia-400 text-zinc-50 transition-all ease-out duration-[0.5] group-hover:-translate-y-full">
            {head2}
          </h1>
        </div>
        <img
